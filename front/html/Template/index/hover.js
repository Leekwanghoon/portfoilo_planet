!function (e, t) {
    ...
    return t = t && t.hasOwnProperty("default")
        ? t.default
        : t,
    function (n) {
        function i() {
        ...
        if (r) 
            if (a && s && o) {
                ...
                var C = new e.ShaderMaterial({
                        ...
                        vertexShader: "\nvarying vec2 vUv;\nvoid main() {\n  vUv = uv;\n  gl_Position = projectionMat" +
                                "rix * modelViewMatrix * vec4( position, 1.0 );\n}\n",
                        fragmentShader: "\nvarying vec2 vUv;\n\nuniform float dispFactor;\nuniform float dpr;\nuniform " +
                                ...
                                "2 dispVec = vec2(disp.r, disp.g);\n\n  vec2 uv = 0.5 * gl_FragCoord.xy / (res." +
                                "xy) ;\n  vec2 myUV = (uv - vec2(0.5))*res.zw + vec2(0.5);\n\n\n  vec2 distorte" +
                                "dPosition1 = myUV + getRotM(angle1) * dispVec * intensity1 * dispFactor;\n  ve" +
                                "c2 distortedPosition2 = myUV + getRotM(angle2) * dispVec * intensity2 * (1.0 -" +
                                " dispFactor);\n  vec4 _texture1 = texture2D(texture1, distortedPosition1);\n  " +
                                "vec4 _texture2 = texture2D(texture2, distortedPosition2);\n  gl_FragColor = mi" +
                                "x(_texture1, _texture2, dispFactor);\n}\n",
                        transparent: !0,
                        opacity: 1
                    }),
